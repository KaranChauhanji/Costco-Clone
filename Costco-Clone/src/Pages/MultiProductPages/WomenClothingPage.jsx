...
const WomenClothingPage = () => {
  ...
  useEffect(()=>{
    ...
    return (
      <Box>
        <Header />
        <Text fontWeight={400} fontSize={'30px'} p={[5,5,10,10]}>Clothing for Women</Text>
        <Flex
          pr={20}
          pl={20}
          pt={4}
        ...
        <Select variant='outline' placeholder='Choose' w={'60%'} outline={'1px solid rgba(0,0,0,0.4)'}  borderRadius={'none'} cursor={"pointer"} onClick={handleChange}>
